...
public class ExtractWords {
	...
	public static void main(String[] args) {
		...
		ToIgnoreFile toExcludeFile = new ToIgnoreFile(toIgnoreFileName); //contiene il file con le parole da ignorare e le parole da ignorare
	...
	public static void printResult(ArrayList<Occurrence> occ) {
